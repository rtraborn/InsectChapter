...
We will compare samples from selected embryonic (E01h-E04h; E22h-E24h) tissues, representing the beginning and end of embryonic development.
...
fastq-dump --split-files SRR424686
\end{lstlisting}

We continue with downloading the RAMPAGE libraries from late embryonic tissues:

\begin{lstlisting}
fastq-dump --split-files SRR424704
fastq-dump --split-files SRR424705
fastq-dump --split-files SRR424706
\end{lstlisting}
