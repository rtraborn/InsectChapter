...
The analyses described herein require a workstation capable of modern bioinformatics computing. 
Since installation of new packages will most likely be required, it will be necessary for the participant to have superuser privileges on the machine.
...
\begin{itemize} 
\item 8GB RAM
\item 20-30GB hard disk storage
\item 
\end{itemize}
